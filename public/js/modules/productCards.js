const renderProductCard = ({id, photo, model, prices}) => {
   ...
   <div class="favorites js-favorites">
                        ...
                        <a href="#" id="${id}" class="link column aic js-link-card">
                            ...
                            <div class="pro duct-image row jcc">
                                <img src="images/autocards/${photo}" alt="" class="image js-image-card">   
                            </div>
                        ...
                        <button onclick="location.href='/raschet.php'" type="button" class="addCart buy-button js-buy-button">РАСЧЕТ</button>
                        
   `;
   return li;
};
{/* <a href="/auto.html" class="addCart buy-button js-buy-button">РА</a> */}
const appendProductCard = (product, container) => {
   container.append(product);
}

const renderProductCards = (products, container) => {
   container.innerHTML = ''; // строка для фильтров
